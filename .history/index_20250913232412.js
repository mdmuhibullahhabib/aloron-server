...
app.post('/create-ssl-payment', async (req, res) => {
  ...
  const initiate = {
    ...
    tran_id: trxid,
    success_url: "http://localhost:5001/success-payment",
    fail_url: "http://localhost:5001/fail-payment",
    cancel_url: "http://localhost:5001/cancel-payment",
    ipn_url: "http://localhost:5001/ipn-success-payment",
    cus_name: "Customer Name",
    cus_email: payment.email,
    cus_add1: "Dhaka",
...
//   );
  ...
  // Delete cart items (optional)
  // const query = {
  //   _id: { $in: paymentSuccess.cartIds.map((id) => new ObjectId(id)) },
  // };
...
//   console.log("fail payment", req.body);
...
//   console.log("cancel payment", req.body);
