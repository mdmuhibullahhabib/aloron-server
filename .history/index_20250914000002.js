...
async function run() {
    try {
        ...
        const qs = require("qs"); // 👉 লাগবে form-urlencoded বানাতে
...
app.post('/create-ssl-payment', async (req, res) => {
    try {
        ...
        const initiate = {
            ...
            currency: "BDT",
            tran_id: trxid,
            success_url: "http://localhost:5000/success-payment", // backend route
            fail_url: "http://localhost:5173/fail",
        ...
        // step 2: send the request to sslcommerz (form-urlencoded)
